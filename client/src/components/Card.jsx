...
/>
      <div className="p-4">
        ...
        {isHalalCertified && <span className="inline-block bg-green-100 text-green-800 text-xs font-semibold mt-2 px-2.5 py-0.5 rounded dark:bg-green-200 dark:text-green-900">Halal Certified</span>}
      </div>
    </Link>
  );
};
