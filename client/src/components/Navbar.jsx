const Navbar = () => {
  ...
  const handleSignOut = async () => {
    ...
    setIsMenuOpen(false); // Ensure the mobile menu is closed upon sign out
  };
    ...
    <header>
      <nav className="bg-white px-2 sm:px-4 py-2.5 shadow-md">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          ...
          <button onClick={toggleMenu} data-collapse-toggle="mobile-menu" type="button" className="inline-flex items-center p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200" aria-controls="mobile-menu" aria-expanded="false" aria-label="Toggle navigation">
            {/* Menu Icon */}
          </button>
