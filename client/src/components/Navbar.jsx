        ...
        <div className={`${isMenuOpen ? '' : 'hidden'} w-full md:block md:w-auto`} id="mobile-menu">
          <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
            {user ? (
              ...
              <>
                <li>
                  <Link to="/user-sign-in" className="block py-2 pr-4 pl-3 text-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0" onClick={() => setIsMenuOpen(false)}>Sign In/Up (Users)</Link>
                </li>
                <li>
                  <Link to="/business-sign-in" className="block py-2 pr-4 pl-3 text-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0" onClick={() => setIsMenuOpen(false)}>Sign In/Up (Businesses)</Link>
                </li>
              </>
            )}
          </ul>
