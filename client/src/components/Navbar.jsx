                ...
                {isUserDropdownOpen && (
                  <div className="absolute right-0 z-50 mt-2 py-2 w-48 bg-white rounded shadow-xl">
                    {user ? (
                      ...
                      <>
                        <EnhancedLink to="/user-sign-in" className={location.pathname === '/user-sign-in' ? 'text-blue-500' : ''}>
                          User Sign In
                        </EnhancedLink>
                        <EnhancedLink to="/user-sign-up" className={location.pathname === '/user-sign-up' ? 'text-blue-500' : ''}>
                          User Sign Up
                        </EnhancedLink>
                      </>
                    )}
