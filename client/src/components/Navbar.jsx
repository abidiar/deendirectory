        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="md:hidden">
              <button onClick={() => toggleDropdown('user')} className="text-lg text-gray-600 hover:text-gray-800">
                For Users
                {/* SVG arrow icon */}
              </button>
              {isDropdownOpen.user && (
              ...
              <button onClick={() => toggleDropdown('business')} className="text-lg text-gray-600 hover:text-gray-800">
                For Businesses
                {/* SVG arrow icon */}
              </button>
