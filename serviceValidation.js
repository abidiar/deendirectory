...
const db = require('../models'); // This should be the path to your models
const Category = db.Category; // Make sure this is correctly pointing to your Category model
...
exports.validateService = [
  ...
  body('phone_number').notEmpty().withMessage('Phone number is required')
    .matches(/^\(?\d{3}\)?[-.\s]?\d{3}[-.\s]?\d{4}$/).withMessage('Invalid phone number format'),
